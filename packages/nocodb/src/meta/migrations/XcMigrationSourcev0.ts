...
import * as nc_202603230000_fine_grained_api_tokens from './v0/nc_202603230000_fine_grained_api_tokens';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603230000_fine_grained_api_tokens',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603230000_fine_grained_api_tokens':
        return nc_202603230000_fine_grained_api_tokens;
    }
  }
}
